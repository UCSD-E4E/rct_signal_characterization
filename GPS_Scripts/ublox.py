...
msg_types = {
    ...
    (CLASS_NAV, MSG_NAV_PVT)    : UBloxDescriptor('NAV_PVT',
                                                  #'<IHBBBBBBIiBBBBiiiiiiiiiiiiiH6s5s',
                                                  '<IHBBBBBBIiBBBBiiiiIIiiiiiIIH6siI',
                                                  ['iTOW', 'year', 'month', 'day', 'hour', 'min', 'sec', 'valid', 'tAcc', 'nano', 'fixType', 'flags', 'flags2', 'numSV', 'lon', 'lat', 'height', 'hMSL', 'hAcc', 'vAcc', 'velN', 'velE', 'velD', 'gspeed', 'headMot', 'sAcc', 'headAcc', 'pDOP', 'reserved1', 'headVeh', 'reserved2' ]),
