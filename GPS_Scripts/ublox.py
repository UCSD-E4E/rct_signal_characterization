...
msg_types = {
    ...
    (CLASS_NAV, MSG_NAV_PVT)    : UBloxDescriptor('NAV_PVT',
                                                  '<IHBBBBBBIiiBBBiiiiiiiiiiiiiH6s5s',
                                                  ['iTOW', 'year', 'month', 'day', 'hour', 'min', 'sec', 'valid', 'tAcc', 'nano', 'fixType', 'flags', 'flags2', 'numSV', 'lon', 'lat', 'height' 'hMSL', 'hAcc', 'vAcc', 'velN', 'velE', 'velD', 'gspeed', 'headMot', 'sAcc', 'headAcc', 'pDOP', 'reserved1', 'headVeh', 'magDec', 'magAcc' ]),
