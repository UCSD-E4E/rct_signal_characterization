...
var button_5 = document.getElementById("button_5");	//toggle on
var button_5 = document.getElementById("button_6"); // toggle off
	...
	request.onreadystatechange = function () {
		if (request.readyState == 4 && request.status == 200 && pic != 5) {
			...
			if ( !(data.localeCompare("0")) ){
				Buttons[pic].src = "img/red/x_"+pic+".jpg";
			}
			else if ( !(data.localeCompare("1")) ) {
				Buttons[pic].src = "img/green/check_"+pic+".jpg";
			}
